...
11. Use `cargo run --bin promptvault-cli -- work-session-evidence-proposals
   ...
   session evidence.
12. Use `cargo run --bin promptvault-cli -- work-session-index --batch-files 25
