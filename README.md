...
`WORKING_LOG.md`, and `PROJECT_STATUS.md`. Status export, candidates, and the
review queue also classify those source artifacts as handoff logs, work logs,
project-status files, progress logs, generated reports, dated work logs, or
generic progress artifacts so project/day management can distinguish canonical
handoff notes from generated reports.
