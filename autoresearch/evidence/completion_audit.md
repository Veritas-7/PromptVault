...
| Single Markdown export | `/tmp/promptvault-full-quality.md` and prior `/Users/wj/Documents/PromptVault/promptvault-export-2026-06-03-152155.md` | PASS |
| Full local session scan | Current release CLI exported 155,481 prompts from 27,606 files in 1m34s | PASS |
...
- `cargo check`: PASS.
- `cargo test`: PASS, 7 tests passed.
...
- Full release scan: PASS, current code exported 155,481 prompts from 27,606 files to `/tmp/promptvault-full-quality.md`, output `364M`, UTF-8 Markdown text.
- Full release scan response payload: PASS, `returned_prompt_count=0`, `prompts_truncated=true`, `markdown_included=false`.
- Full release quality distribution: PASS, `average_quality=66.49`, `weak_prompt_count=61,242`, and top quality gaps `constraints`, `verification`, `output_format`, `action_verb`, `context`.
