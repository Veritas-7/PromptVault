use promptvault_lib::{
    ...
    run_project_work_log_freeze, run_project_work_report, run_project_work_summary, run_scan,
    ...
    ProjectWorkLogFreezeOptions, ProjectWorkReportOptions, ProjectWorkSummaryOptions,
