...
function App() {
  ...
  const workSessionIndexCompletionPlan = workSessionIndexCompletionPlanText(
    workSessionIndexResult,
    WORK_SESSION_INDEX_RECOMMENDED_LARGE_BATCH_FILES,
  ...
  async function rejectWorkSessionEvidenceSourceAuditItems() {
    const rejectableItems = workSessionEvidenceSourceAuditBulkRejectableItems(
  ...
  return (
    <main className="shell">
      ...
      <section className="panel work-summary-panel">
        ...
        {workSessionIndexCompletionPlan ? (
          <div className="work-summary-index" data-work-session-index-completion-plan="true">
            <CheckCircle2 size={15} />
            <span>{workSessionIndexCompletionPlan}</span>
          </div>
        ) : null}
        ...
        {workSessionEvidenceSourceAuditResult ? (
          <div className="work-summary-list" data-work-session-evidence-source-audit="true">
            <article className="work-summary-row work-log-proposal-row">
              ...
              <button
                aria-label={`원본 감사 결과 기준 세션 근거 후보 ${workSessionEvidenceSourceAuditBulkRejectable.length.toLocaleString()}개 일괄 거절`}
                className="inline-action compact-action"
                data-reject-work-session-evidence-source-audit-items="true"
                disabled={isTopLevelActionLocked || workSessionEvidenceSourceAuditBulkRejectable.length === 0}
              ...
              visibleWorkSessionEvidenceSourceAuditItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {manualInspectReason ? (
                      <span data-work-session-evidence-source-audit-manual-inspect-note={item.candidate_id}>
                        {manualInspectReason}
                      </span>
                    ) : null}
