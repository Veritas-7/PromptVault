  ...
  return {
    ...
    proposals: [
      ...
      },
      {
        ...
        source_path: "/Users/example/Ai/System/10_Projects/UnknownProject/working.md",
        source_file: "working.md",
        date: null,
    ...
    rows: [
      {
        ...
        latest_source_path: "/Users/example/Ai/System/10_Projects/01_apps-products/PromptVault/PROGRESS_LOG.md",
...
test("work management overview next action prioritizes daily task management gaps", () => {
  ...
  assert.equal(
    ...
    "다음 조치 · 제목 정규화 큐 검토 후 같은 날짜 세션 후보 2건 수동 연결 검토",
  );

  const titleAndNearbySession = buildWorkManagementOverview({
    statusExport: {
      ...statusExportResult(),
      rows: [{
        ...statusExportResult().rows[0],
  ...
  assert.equal(
    workManagementOverviewNextActionText(titleAndNearbySession),
    "다음 조치 · 제목 정규화 큐 검토 후 인접 날짜 세션 후보 검토 · 2026-06-08 · 1일 차이",
  );
    ...
    statusExport: {
      ...
      rows: [
        ...statusExportResult().rows,
        {
          ...
          latest_source_path: "/Users/example/Ai/System/10_Projects/01_apps-products/RepoTutorStudio/working.md",
    ...
    coverage: {
      ...
      files: [
        ...coverage.files,
        {
          ...
          source_path: "/Users/example/Ai/System/10_Projects/OnlyProgress/working.md",
          source_file: "working.md",
          status: "parsed",
          work_item_count: 50,
